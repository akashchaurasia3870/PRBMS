            ...
            <div class="bg-white shadow-xl rounded-lg overflow-y-auto">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h1 class="text-2xl sm:text-3xl font-bold text-white">Add New Category</h1>
                            <p class="text-blue-100 mt-1">Create a new category for organizing inventory items</p>
                        </div>
                    </div>
                ...
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('category.v2.new') }}" class="space-y-6">
                        @csrf
